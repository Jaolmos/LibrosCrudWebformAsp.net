...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Gestiona tus libros</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <asp:HyperLink ID="HyperLinkAgregarLibro" runat="server" NavigateUrl="~/Pages/Libros/AgregarLibro.aspx" CssClass="nav-link">Nuevo Libro</asp:HyperLink>
        </li>
      </ul>
    </div>
  </div>
